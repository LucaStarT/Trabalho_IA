...
def main():
    ...
    arvore.ligar('Estádio_Al_Thumama', 'Ticketing_Centre_FWC2022', distancia_padrao.distancias_inadmissivel['Estádio_Al_Thumama']['Ticketing_Centre_FWC2022'][1] )
    arvore.ligar('Estádio_Al_Thumama', 'Estádio_Internacional_Khalifa', distancia_padrao.distancias_inadmissivel['Estádio_Al_Thumama']['Estádio_Internacional_Khalifa'][1] )
    arvore.ligar('Estádio_Al_Thumama', 'Estádio_974', distancia_padrao.distancias_inadmissivel['Estádio_Al_Thumama']['Estádio_974'][1] )
    arvore.ligar('Estádio_Internacional_Khalifa', 'Al_Waab_QLM', distancia_padrao.distancias_inadmissivel['Estádio_Internacional_Khalifa']['Al_Waab_QLM'][1] )
    arvore.ligar('Estádio_Internacional_Khalifa', 'Rayyan_Family_Park_1', distancia_padrao.distancias_inadmissivel['Estádio_Internacional_Khalifa']['Rayyan_Family_Park_1'][1] )
    arvore.ligar('Estádio_Internacional_Khalifa', 'Estádio_Al_Thumama', distancia_padrao.distancias_inadmissivel['Estádio_Internacional_Khalifa']['Estádio_Al_Thumama'][1] )
    arvore.ligar('Estádio_Cidade_da_Educação', 'Rayyan_Family_Park_1', distancia_padrao.distancias_inadmissivel['Estádio_Cidade_da_Educação']['Rayyan_Family_Park_1'][1] )
    arvore.ligar('Estádio_Cidade_da_Educação', 'Al_Gharrafa_Park', distancia_padrao.distancias_inadmissivel['Estádio_Cidade_da_Educação']['Al_Gharrafa_Park'][1] )
    arvore.ligar('Estádio_Cidade_da_Educação', 'Al_Messila_Resort', distancia_padrao.distancias_inadmissivel['Estádio_Cidade_da_Educação']['Al_Messila_Resort'][1] )
    arvore.ligar('Estádio_974', 'Westin_Hotel_Doha', distancia_padrao.distancias_inadmissivel['Estádio_974']['Westin_Hotel_Doha'][1] )
    arvore.ligar('Estádio_974', 'Fan_Fest_Doha_Park_Al_Bidda', distancia_padrao.distancias_inadmissivel['Estádio_974']['Fan_Fest_Doha_Park_Al_Bidda'][1] )
    arvore.ligar('Estádio_974', 'Estádio_Al_Thumama', distancia_padrao.distancias_inadmissivel['Estádio_974']['Estádio_Al_Thumama'][1] )
    ...
    arvore.ligar('Westin_Hotel_Doha', 'Estádio_974', distancia_padrao.distancias_inadmissivel['Westin_Hotel_Doha']['Estádio_974'][1] )
    ...
    arvore.ligar('Al_Messila_Resort', 'Estádio_Cidade_da_Educação', distancia_padrao.distancias_inadmissivel['Al_Messila_Resort']['Estádio_Cidade_da_Educação'][1] )
    ...
    arvore.ligar('Fan_Fest_Doha_Park_Al_Bidda', 'Estádio_974', distancia_padrao.distancias_inadmissivel['Fan_Fest_Doha_Park_Al_Bidda']['Estádio_974'][1] )
    ...
    arvore.ligar('Ticketing_Centre_FWC2022', 'Estádio_Al_Thumama', distancia_padrao.distancias_inadmissivel['Ticketing_Centre_FWC2022']['Estádio_Al_Thumama'][1] )
    arvore.ligar('Al_Waab_QLM', 'Estádio_Internacional_Khalifa', distancia_padrao.distancias_inadmissivel['Al_Waab_QLM']['Estádio_Internacional_Khalifa'][1] )
    ...
    arvore.ligar('Rayyan_Family_Park_1', 'Estádio_Internacional_Khalifa', distancia_padrao.distancias_inadmissivel['Rayyan_Family_Park_1']['Estádio_Internacional_Khalifa'][1] )
    arvore.ligar('Rayyan_Family_Park_1', 'Estádio_Cidade_da_Educação', distancia_padrao.distancias_inadmissivel['Rayyan_Family_Park_1']['Estádio_Cidade_da_Educação'][1] )
    ...
    arvore.ligar('Al_Gharrafa_Park', 'Estádio_Cidade_da_Educação', distancia_padrao.distancias_inadmissivel['Al_Gharrafa_Park']['Estádio_Cidade_da_Educação'][1] )
